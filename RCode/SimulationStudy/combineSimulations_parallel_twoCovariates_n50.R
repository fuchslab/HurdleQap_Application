...
#--------------
# n = 50
setwd("~/Workspaces/2C_NV_n50")
load("simulation_twoCov_NV_n50_1000_1.Rdata")
allcoefs <- coefs
# hurdle
...
for (i in 2:2259){
  if(file.exists(paste0("simulation_twoCov_NV_n50_1000_", i, ".Rdata"))){
    load(paste0("simulation_twoCov_NV_n50_1000_", i, ".Rdata"))
...
setwd("~/Workspaces/2C_GV_n50")
for (i in 1001:2380){
  if(file.exists(paste0("simulation_twoCov_GV_n50_1000_", i, ".Rdata"))){
    load(paste0("simulation_twoCov_GV_n50_1000_", i, ".Rdata"))
    allcoefs <- c(allcoefs, coefs)
    allpvalues_hurdleQap <- c(allpvalues_hurdleQap, pvalues_hurdleQap)
    allcoefsHurdleQap <- c(allcoefsHurdleQap, coefsHurdleQap)
    allcoefsHurdle <- c(allcoefsHurdle, coefs_hurdle)
...
setwd("~/Workspaces/2C_NV_n50")
for (i in 2001:2200){
  if(file.exists(paste0("simulation_twoCov_n50_coef01000_", i, ".Rdata"))){
    load(paste0("simulation_twoCov_n50_coef01000_", i, ".Rdata"))
    allcoefs <- c(allcoefs, coefs)
    allpvalues_hurdleQap <- c(allpvalues_hurdleQap, pvalues_hurdleQap)
    allcoefsHurdleQap <- c(allcoefsHurdleQap, coefsHurdleQap)
    allcoefsHurdle <- c(allcoefsHurdle, coefs_hurdle)
...
setwd("~/Workspaces/2C_n50_nullCoef")
for (i in 1:140){
  if(file.exists(paste0("simulation_twoCov_n50_nullCoef1000_", i, ".Rdata"))){
    load(paste0("simulation_twoCov_n50_nullCoef1000_", i, ".Rdata"))
    allcoefs <- c(allcoefs, coefs)
    allpvalues_hurdleQap <- c(allpvalues_hurdleQap, pvalues_hurdleQap)
    allcoefsHurdleQap <- c(allcoefsHurdleQap, coefsHurdleQap)
    allcoefsHurdle <- c(allcoefsHurdle, coefs_hurdle)
...
pdf("Plots/TrueEstimatedCoefficents_hurdleQap_n50_lambda.pdf", width = 15, height = 13)
...
pdf("Plots/plot_hurdleQap_pvalues_n50.pdf", width = 13, height = 13)
plot_hurdleQap_pvalues <- grid.arrange(g_bin_dist, g_bin_pub, g_pois_dist, g_pois_pub, ncol = 2,
                                       top = textGrob("Two-sided hurdle-QAP p-values for coefficient pairs, n = 50", gp = gpar(fontsize = 20)))
...
pdf("Plots/TrueEstimatedCoefficents_hurdle_n50.pdf", width = 13, height = 13)
plot_hurdle_estimated <- grid.arrange(g_bin_dist, g_bin_pub, g_pois_dist, g_pois_pub, ncol = 2,
                                      top = textGrob("True vs. estimated hurdle coefficients, n = 50", gp = gpar(fontsize = 20)))
...
pdf("Plots/TrueEstimatedCoefficents_hurdle_n50_lambda.pdf", width = 15, height = 13)
grid.draw(p_combined) 
dev.off()
...
pdf("Plots/plot_hurdle_pvalues_n50.pdf", width = 13, height = 13)
plot_hurdle_pvalues <- grid.arrange(g_bin_dist, g_bin_pub, g_pois_dist, g_pois_pub, ncol = 2,
                                    top = textGrob("Original hurdle p-values for coefficient pairs, n = 50", gp = gpar(fontsize = 20)))
...
pdf("Plots/TrueEstimatedCoefficents_poissonQap_n50.pdf", width = 13, height = 6)
plot_poissonQap_estimated <- grid.arrange(g_pois_dist, g_pois_pub, ncol = 2,
                                          top = textGrob("True vs. estimated poisson-QAP coefficients, n = 50", gp = gpar(fontsize = 20)))
...
pdf("Plots/TrueEstimatedCoefficents_poissonQap_n50_lambda.pdf", width = 15, height = 6)
grid.draw(p_combined) 
dev.off()
...
pdf("Plots/plot_poissonQap_pvalues_n50.pdf", width = 13, height = 13)
plot_poissonQap_pvalues <- grid.arrange(g_bin_dist, g_bin_pub, g_pois_dist, g_pois_pub, ncol = 2,
                                        top = textGrob("Two-sided poisson-QAP p-values for coefficient pairs, n = 50", gp = gpar(fontsize = 20)))
...
pdf("Plots/TrueEstimatedCoefficents_poisson_n50.pdf", width = 13, height = 6)
plot_poisson_estimated <- grid.arrange(g_pois_dist, g_pois_pub, ncol = 2,
                                          top = textGrob("True vs. estimated poisson coefficients, n = 50", gp = gpar(fontsize = 20)))
...
pdf("Plots/TrueEstimatedCoefficents_poisson_n50_lambda.pdf", width = 15, height = 6)
grid.draw(p_combined) 
dev.off()
...
pdf("Plots/plot_poisson_pvalues_n50.pdf", width = 13, height = 13)
plot_poisson_pvalues <- grid.arrange(g_bin_dist, g_bin_pub, g_pois_dist, g_pois_pub, ncol = 2,
                                     top = textGrob("Original poisson p-values for coefficient pairs, n = 50", gp = gpar(fontsize = 20)))
