...
createData <- function(n = 200,
  ...
  #beta_binDist <- rtruncnorm(1, a = beta_binDist_min, b = beta_binDist_max, mean = 0, sd = 0.001)
  beta_poisDist <- rtruncnorm(1, a = beta_poisDist_min, b = beta_poisDist_max, mean = 0, sd = 0.001)
  beta_binPub <- rtruncnorm(1, a = beta_binPub_min, b = beta_binPub_max, mean = 0, sd = 0.001)
  beta_poisPub <- rtruncnorm(1, a = beta_poisPub_min, b = beta_poisPub_max, mean = 0, sd = 0.001)
...
session <- sessionInfo()
save.image(file = paste0("Workspaces/2C_n200_nullCoef/simulation_twoCov_n200_nullCoef", QAPreps, "_", taskid, ".Rdata"))
