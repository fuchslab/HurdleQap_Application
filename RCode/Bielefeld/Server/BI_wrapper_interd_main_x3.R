...
# three covariates
Original_interd_main_x3 <- hurdleQap(y = my_y, x = my_x[1:3], removeControl = TRUE, logicMatrix = matInstLogic, maxDist = 100000, kbasis = 8, reps = 1000)
save(Original_interd_main_x3, file = "Workspaces/Original_interd_main_x3_wrapper_Bielefeld.RData")
