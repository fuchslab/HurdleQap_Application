...
# three covariates
Original_all_all_x3 <- hurdleQap(y = my_y, x = my_x[1:3], removeControl = FALSE, logicMatrix = NULL, maxDist = 100000, kbasis = 8, reps = 1000)
save(Original_all_all_x3, file = "Workspaces/Original_all_all_x3_wrapper_Bielefeld.RData")
