...
# author network: dist 100000, main-main, interdisciplinary
# two covariates
Original_interd_main_x2 <- hurdleQap(y = my_y, x = my_x[1:2], removeControl = TRUE, logicMatrix = matInstLogic, maxDist = 100000, kbasis = 8, reps = 1000)
save(Original_interd_main_x2, file = "Workspaces/Original_interd_main_x2_wrapper_Bielefeld.RData")
