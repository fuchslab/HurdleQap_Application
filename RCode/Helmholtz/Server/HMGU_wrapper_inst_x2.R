...
# two covariates
Original_inst_x2 <- hurdleQap(y = my_yI, x = my_xI[1:2], removeControl = FALSE, logicMatrix = NULL, maxDist = 1000, kbasis = 8, reps = 1000)
save(Original_inst_x2, file = "Workspaces/Permutations/Original_inst_x2.RData")
