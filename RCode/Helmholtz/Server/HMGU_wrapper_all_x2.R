...
# two covariates
Original_all_x2 <- hurdleQap(y = my_y, x = my_x[1:2], removeControl = FALSE, logicMatrix = NULL, maxDist = 1000, kbasis = 8, reps = 1000)
save(Original_all_x2, file = "Workspaces/Original_all_x2_wrapper.RData")
